...
$config = array(
    ...
    'NOT_AUTH_ACTION'     => 'public_relationlist,public_nocheck,public_check',       // 默认无需认证操作
    ...
    'TMPL_FILE_DEPR'        =>  '/',
    'TMPL_ACTION_ERROR'     =>  TMPL_PATH.'Admin/Public/error.html',
    'TMPL_ACTION_SUCCESS'   =>  TMPL_PATH.'Admin/Public/success.html',
    'TMPL_EXCEPTION_FILE'   =>  TMPL_PATH.'Admin/Public/exception.html',
