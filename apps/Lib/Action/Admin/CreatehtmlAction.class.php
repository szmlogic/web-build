    ...
    public function update_urls()
    {
        ...
        if($this->Categorys){
            ...
            foreach ($this->Categorys as $r){
                ...
                if($_GET['modelid'] && $r['modelid'] !=  $_GET['modelid']) continue;

                if(ACTION_NAME=='Updateurl' && $r['model']=='Page') continue;

                if(ACTION_NAME=='Createlist' && $r['ishtml']!=1) continue;

                if((ACTION_NAME=='Createshow' && $r['ishtml']!=1) || (ACTION_NAME=='createshow' && $r['model']=='Page')) continue;
