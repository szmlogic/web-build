...
KindEditor.plugin('filemanager', function(K) {
	...
	self.plugin.filemanagerDialog = function(options) {
		var width = K.undef(options.width, 700),
			height = K.undef(options.height, 550),
			upUrl = options.upUrl;
			clickFn = options.clickFn;
		var html = ['<div class="ke-map" style="width:700px;height:550px;"></div>'].join('');
		...
		var iframe = K('<iframe class="ke-textarea" frameborder="0" src="' + upUrl + '" style="width:700px;height:550px;border:none;"></iframe>');
		function ready() {
