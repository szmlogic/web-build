            ...
            <div class="panel-body">
                <form class="myform form-horizontal" method='post' action="<?php echo U('Sysconfig/save');?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <input type="text" class="form-control" name="mail_server" value="<?php echo ($sysconf['mail_server']); ?>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3">邮件发送端口</label>
                        <div class="col-md-3">
                            <input type="text" class="form-control" name="mail_port" value="<?php echo ($sysconf["mail_port"]); ?>"/>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <input name="mail_auth" value="1" type="radio" <?php if($sysconf["mail_auth"] == 1): ?>checked<?php endif; ?>> 开启
                            <input name="mail_auth" value="0" type="radio" <?php if($sysconf["mail_auth"] == 0): ?>checked<?php endif; ?> > 关闭
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <input type="text" class="form-control" name="mail_user" value="<?php echo ($sysconf["mail_user"]); ?>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3">验证密码</label>
                        <div class="col-md-7" id="mail_password">
                            <?php if(!empty($sysconf['mail_password'])){ ?>
