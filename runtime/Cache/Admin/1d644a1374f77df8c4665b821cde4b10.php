...
<div class="table-toolbar">
    <div class="row">
        <div class="col-md-12">
            <a class="btn btn-primary" href="<?php echo U('User/add');?>"> 新增</a>
        ...
        <form name="myform" action="<?php echo U('user/deleteall');?>" method="post">
            <table class="table table-hover table-striped table-bordered">
                ...
                <tr>
                    ...
                    <th>用户名</th>
                    <th>邮箱</th>
                    <?php if($_SESSION['admin']['id']== 1): ?><th>所属角色</th><?php endif; ?>
                    <th>最后登录时间</th>
                    <th>状态</th>
                    <th>操作管理</th>
                </tr>
                ...
                <?php if(empty($list)): ?><tr class="table-data-empty">
                    ...
                    <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                            <td><input class="inputcheckbox " name="ids[]" value="<?php echo ($vo['id']); ?>" type="checkbox" ></td>
                            <td><?php echo ($vo["username"]); ?></td>
                            <td><?php echo ($vo["email"]); ?></td>
                            <?php if($_SESSION['admin']['id']== 1): ?><td><?php echo ($role[$vo['role']]); ?></td><?php endif; ?>
                            ...
                            <td>
                                <a class="btn btn-xs btn-primary" href="<?php echo U('User/edit','id='.$vo['id']);?>">编辑</a>
                                <a class="btn btn-xs btn-danger" href="javascript:confirm_delete('<?php echo U('User/delete',array('id'=>$vo['id']));?>')">删除</a>
                            </td>
