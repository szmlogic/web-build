...
<div class="container-fluid">
    ...
    <?php if($_SESSION['admin']['id']== 1): ?><div class="table-toolbar">
        <a class="btn btn-primary" href="<?php echo U('Form/add');?>">添加表单</a>
    </div><?php endif; ?>

    <form name="myform" action="<?php echo U('Form/listorder');?>" method="post">
        <table class="table table-bordered table-hover table-condensed">
            ...
            <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                    ...
                    <td class="manage">
                        <a class="btn btn-xs btn-primary" href="<?php echo U('Form/content',array(formid=>$vo['id']));?>">内容维护</a>
                        <?php if($_SESSION['admin']['role'] == 1):?>
                        <a class="btn btn-xs btn-primary" href="<?php echo U('FormField/index',array(formid=>$vo['id']));?>">表单字段</a>
                        <a class="btn btn-xs btn-primary" href="<?php echo U('Form/edit',array(id=>$vo['id']));?>">编辑</a>
                        <a class="btn btn-xs btn-danger" href="<?php echo U('Form/delete',array(id=>$vo['id']));?>"  onclick="return confirm('您确定要卸载吗？')">删除</a>
                        <?php endif;?>
                    </td>
