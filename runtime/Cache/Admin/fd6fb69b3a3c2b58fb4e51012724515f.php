...
<div class="container-fluid">
    ...
    <div class="table-toolbar">
        <a href="<?php echo U('Database/recover');?>" class="btn btn-sm btn-primary">数据还原</a>
    </div>

    <form id="myform" method="post" action="<?php echo U('Database/backup');?>">
        <table class="table table-bordered">
            ...
            <tr id="js-showtables">
                ...
                <td><?php if(is_array($dataList)): $i = 0; $__LIST__ = $dataList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><label class="checkbox inline w-200">
                        <input type="checkbox" name="tables[]" value="<?php echo ($vo["Name"]); ?>">
                                <?php echo ($vo["Name"]); ?>
