...
<div class="container-fluid">
    ...
    <form id="myform" class="form-horizontal" method='post' action="<?php echo U('Config/edit');?>">
        <div class="form-group">
            <label class="control-label col-md-2">变量名:</label>
            <div class="col-md-5">
                <input type="text" class="form-control"  name="varname" value="<?php echo ($vo["varname"]); ?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-5">
                <input type="text" class="form-control" name="info" value="<?php echo ($vo["info"]); ?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-5">
                <input type="text"  class="form-control" name="value" value="<?php echo ($vo["value"]); ?>" >
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-md-2">变量类型:</label>
            <div class="col-md-5">
                <input type="radio" name="type" <?php if(($vo["type"]) == "0"): ?>checked<?php endif; ?> value="0">文本
                <input type="radio" name="type" <?php if(($vo["type"]) == "1"): ?>checked<?php endif; ?> value="1">图片
            </div>
        </div>
        <div class="form-group">
