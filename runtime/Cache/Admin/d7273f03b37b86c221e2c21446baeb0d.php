...
<form id="myform" class="form-horizontal" action="<?php echo U('Slide/edit');?>" method="post">

    <div class="form-group">
        <label class="control-label col-md-2"><font color="red">*</font>名称</label>
        <div class="col-md-6">
            <input type="text" id="name" name="name" value="<?php echo ($vo["name"]); ?>" class="form-control"  validate="required:true,cn_username:true, minlength:2, maxlength:20"/>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-6">
            <input type="text" id="width" name="width" value="<?php echo ($vo["width"]); ?>" class="form-control" validate="required:true,number:true, minlength:1, maxlength:20"/>
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-md-2">幻灯片高</label>
        <div class="col-md-6">
            <input type="text" id="height" name="height" value="<?php echo ($vo["height"]); ?>" class="form-control" validate="required:true,number:true, minlength:1, maxlength:20"/>
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-md-2">图片数量</label>
        <div class="col-md-6">
            <input type="text" id="height" name="num" value="<?php echo ($vo["num"]); ?>" class="form-control" />
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-md-2">状态</label>
        <div class="col-md-6">
            <?php echo Form::radio(array('field'=>'status','options'=>array('1'=>L('enable'),'0'=>L('disable'))),$vo['status']);?>
        </div>
    </div>
    ...
    <div class="form-actions">
        ...
        <a href="<?php echo U('Slide/index');?>" class="btn btn-sm btn-primary">返回广告列表</a>
    </div>
</form>
