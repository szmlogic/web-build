...
<div class="container-fluid">
    ...
    <div class="table-toolbar">
        <div class="row">
            <div class="col-md-12">
                <a class="btn btn-primary" href="<?php echo U('Config/add');?>">新增</a>
                <a class="btn btn-primary" onclick="myform.action='<?php echo U('Config/listorder');?>';$('#myform').submit();" >排序</a>
            </div>
        </div>
    </div>
                    ...
                    <?php if(empty($list)): ?><tr class="table-data-empty">
                        ...
                        <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                                ...
                                <td class="table-cell-2 center">
                                    <a class="btn btn-xs btn-primary" href="<?php echo U('Config/edit',array(id=>$vo['id']));?>">编辑</a>
                                    <a class="btn btn-xs btn-danger" href="javascript:confirm_delete('<?php echo U('Config/delete',array(id=>$vo['id']));?>')">删除</a>
                                </td>
