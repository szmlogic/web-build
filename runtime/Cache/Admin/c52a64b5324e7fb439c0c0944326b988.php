...
<div class="container-fluid">
    ...
    <div class="table-toolbar">
        <a href="<?php echo U('Slide/add');?>" class="btn btn-primary">新增</a>
    </div>
    <?php endif;?>
            ...
            <form name="myform" action="" method="post">
                <table class="table table-bordered table-hover">
                    ...
                    <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                            ...
                            <td class="center"><?php if(($vo['status']) == "1"): ?>启用
                                <?php else: ?>
                                禁用<?php endif; ?></td>
                            <td class="center">
                                <a class="btn btn-primary btn-xs" href="<?php echo U('Slide/picmanage',array('fid'=>$vo['id']));?>">图片管理</a>
                                <?php if($_SESSION['admin']['role'] == 1):?>
                                <a class="btn btn-info btn-xs" href="<?php echo U('Slide/edit',array('id'=>$vo['id']));?>">编辑</a>
                                <a class="btn btn-danger btn-xs" href="javascript:confirm_delete('<?php echo U('Slide/delete',array('id'=>$vo['id']));?>')">删除</a>
                                <?php endif;?>
                            </td>
