...
<div>
    ...
    <form id="myform" action="<?php echo U('Attachment/edit');?>" method="post">
        <input type="hidden" class="form-control" name="aid" value="<?php echo ($vo["aid"]); ?>">
    <div class="row">
        <div class="col-md-9">
            <div class="form-group">
                <label class="control-label">名称:</label>
                <input type="text" class="form-control" name="filename" value="<?php echo ($vo["filename"]); ?>">
            </div>
            
            <div class="form-group">
                <img src="<?php echo ($vo["filepath"]); ?>" class="col-md-12">
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <p>上传于：<?php echo (todate($vo["createtime"],'Y年m月d日')); ?></p>
                    <p>文件URL：
                        <?php echo ($vo["filepath"]); ?></p>
                    <p>文件名： <?php echo ($vo["filename"]); ?></p>
                    <p>文件类型： <?php echo ($vo["fileext"]); ?></p>
                    <p>文件大小： <?php echo ($vo["filesize"]); ?></p>
                    <!--<p>分辨率： 980 × 498</p>-->
                </div>
