...
<div>
    <form id="myform" class="form-horizontal" method="post" action="<?php echo U('Block/edit');?>">
        <div class="form-group">
            <label class="control-label col-md-2">名称:</label>
            <div class="col-md-8">
                <input type="text" class="form-control" name="name" id="name" value="<?php echo ($vo["name"]); ?>">
            </div>
        </div>
        <div class="form-group env-class">
            ...
            <div class="radio-inline">
                <label>
                <input type="radio" name="type" <?php if(($vo["type"]) == "url"): ?>checked<?php endif; ?> value="url">链接地址
                </label>
            </div>
            <div class="radio-inline">
                <label>
                    <input type="radio" name="type" <?php if(($vo["type"]) == "img"): ?>checked<?php endif; ?> value="img">图片
                </label>
            </div>
            <div class="radio-inline">
                <label>
                    <input type="radio" name="type" <?php if(($vo["type"]) == "text"): ?>checked<?php endif; ?> value="text">文本
                </label>
            </div>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-md-8">
                <?php if($vo['type'] != 'text') : ?>
                <input type="text" class="form-control" name="content" value="<?php echo ($vo["content"]); ?>">
                <?php else :?>
                    <?php echo $Form->editor(array('field'=>'content','moduleid'=>'231','setup'=>array('toolbar'=>'full','flashupload'=>'1')),$vo[content]);?>
                <?php endif;?>
            </div>
        </div>
        <div class="form-group">
