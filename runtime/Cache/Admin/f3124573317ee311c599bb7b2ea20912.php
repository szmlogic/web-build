...
<div class="container-fluid">
    ...
    <div class="table-toolbar">
        <a href="<?php echo U('Kefu/add');?>" class="btn btn-sm btn-primary">添加</a>
        <a class="btn btn-sm btn-primary" onclick="myform.action='<?php echo U('Kefu/listorder');?>';$('#myform').submit();">排序</a>
    </div>
            ...
            <form name="myform" id="myform" action="" method="post">
                <table class="table table-bordered table-hover">
                    ...
                    <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                            ...
                            <td>
                                <?php if(($vo["type"]) == "1"): ?>QQ<?php endif; ?>
                                <?php if(($vo["type"]) == "2"): ?>旺旺<?php endif; ?>
                                <?php if(($vo["type"]) == "3"): ?>Skype<?php endif; ?>
                                <?php if(($vo["type"]) == "4"): ?>电话<?php endif; ?>
                            </td>
                            <td>
                                <?php echo (stripcslashes($vo['code'])); ?>
                            </td>
                            <td>
                                <a class="btn btn-xs btn-primary" href="<?php echo U('Kefu/edit',array('id'=>$vo['id']));?>">编辑</a>
                                <a class="btn btn-xs btn-danger" href="javascript:confirm_delete('<?php echo U('Kefu/delete',array(id=>$vo['id']));?>')">删除</a>
                            </td>
                ...
                <div class="row">
                    <div class="pull-right" id="pages"><?php echo ($page); ?></div>
                </div>
            </form>
        </div>
    </div>
