...
<div class="row">
    <div class="col-md-12">
        <form id="myform" name="myform" class="form-horizontal" action="<?php echo U('Category/add');?>" method="post">
            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane active" id="home">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="catname" id="catname" class="form-control  required" value="<?php echo ($vo['catname']); ?>"  minlength="1" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <div class="thumb_image">
                                ...
                                <input type="button" value="<?php echo L('clean_thumb');?>" onclick="javascript:clean_thumb('image');" class="btn btn-xs btn-primary"/>
                    ...
                    <div class="form-group env-class" >
                        ...
                        <div class="col-md-8">
                            <?php echo Form::radio(array('field'=>'ismenu','options'=>array('1'=>L('yes'),'0'=>L('no'))),1);?>
                        </div>
                    </div>
                    ...
                    <div class="form-group" <?php if($_SESSION['admin']['role'] != 1):?>style="display:none;"<?php endif;?>>
                        ...
                        <div class="col-md-8">
                            <input type="text" name="pagesize" class="form-control w-100" value="<?php if(!empty($vo['pagesize'])): echo ($vo['pagesize']); endif; ?>"/> <font color="red">为空时默认值为系统设置的值</font>
                        </div>
                    </div>
                    ...
                    <div class="form-group" <?php if($_SESSION['admin']['role'] != 1):?>style="display:none;"<?php endif;?>>
                        ...
                        <div class="col-md-8">
                            <div class="selectstyle">
                                ...
                                &nbsp;&nbsp;
                                <input type="checkbox" class="input_checkbox pull-left" id="listtype" name="listtype" onclick="javascript:templatetype();" value="1" <?php if(!empty($vo['listtype'])): ?>checked<?php endif; ?> />是否为封面栏目
                            </div>
                        </div>
                    </div>
                    <div class="form-group" <?php if($_SESSION['admin']['role'] != 1):?>style="display:none;"<?php endif;?>>
                ...
                <div role="tabpanel" class="tab-pane" id="profile">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input name='title' type='text' id='meta_title' value="<?php echo ($vo['title']); ?>" class="form-control"  size='60' maxlength='150'>
                        </div>
                    </div>
...
$('.thumb_image a').click(function(){
    swfupload('image_uploadfile','image','<?php echo L(uploadfiles);?>',1,1,0,1,'jpeg,jpg,png,gif',300,0,'<?php echo ($yzh_auth); ?>',yesdo,nodo);
});
...
showtemplist(modelid,<?php if(empty($vo[listtype])): ?>0<?php else: echo ($vo["listtype"]); endif; ?>);
...
<?php if(!empty($_GET['type'])): ?>$('#modelid').val(0);
