...
<div class="table-toolbar">
    <div class="row">
        <div class="col-md-12">
            <a href="<?php echo U($model_name.'/add');?>" class="btn btn-sm btn-primary">添加</a>
            <a class="btn btn-sm btn-primary" onclick="return confirm_deleteall()">删除</a>
            <a class="btn btn-sm btn-primary" onclick="myform.action='<?php echo U($model_name.'/listorder');?>';$('#myform').submit();" >排序</a>
            <a class="btn btn-sm btn-primary" onclick="content_check();" >审核</a>
            <a class="btn btn-sm btn-primary" onclick="content_nocheck();">取消审核</a>
            <a class="btn btn-sm btn-primary" id="push_btn">推送</a>
            <a class="btn btn-sm btn-primary" id="content_move" >批量移动</a>
        </div>
    </div>
</div>
        ...
        <form name="myform" id="myform" action="" method="post">
            ...
            <table class="table table-hover table-bordered">
                ...
                <tr>
                    ...
                    <th class="w-50"><?php echo L('listorder');?></th>
                    <th width="40">ID</th>
                    <th>标题</th>
                    <th>日期</th>
                ...
                <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                        ...
                        <td class="center table-cell-2">
                            <a class="btn btn-xs btn-primary" href="<?php echo U($model_name.'/edit',array('id'=>$vo['id']));?>">编辑</a>
                            <a class="btn btn-xs btn-danger" href="javascript:confirm_delete('<?php echo U($model_name.'/delete',array('id'=>$vo['id']));?>')">删除</a>
                        </td>
