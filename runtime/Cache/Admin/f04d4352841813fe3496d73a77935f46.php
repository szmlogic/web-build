...
<div class="container-fluid">
    ...
    <div class="table-toolbar">
        <div class="row">
            <div class="col-md-12">
                <a class="btn btn-primary" href="<?php echo U('Block/add');?>">添加碎片</a>
            </div>
        </div>
            ...
            <form id="myform" name="myform" action="<?php echo U('Type/listorder');?>" method="post">
                <table class="table table-hover table-bordered">
                    ...
                    <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                            ...
                            <td>
                                <?php switch($vo["type"]): case "url": ?>链接地址<?php break;?>
                                    <?php case "img": ?>图片<?php break;?>
                                    <?php case "text": ?>文本<?php break;?>
                                    <?php default: endswitch;?>
                            </td>
                            <td>
                                <?php switch($vo["group"]): case "1": ?>pc端<?php break;?>
                                    <?php case "2": ?>wap端<?php break;?>
                                    <?php default: endswitch;?>
                            </td>
                            <td>
                                <a class="btn btn-xs btn-primary" href="<?php echo U('Block/edit',array(id=>$vo['id'],pos=>$vo['pos']));?>">编辑</a>
                                <a class="btn btn-xs btn-danger" href="javascript:confirm_delete('<?php echo U('Block/delete',array(id=>$vo['id']));?>')">删除</a>
                            </td>
