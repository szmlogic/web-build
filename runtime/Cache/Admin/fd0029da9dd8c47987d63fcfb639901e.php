...
<div class="container-fluid">
    ...
    <form id="myform" class="form-horizontal" action="<?php echo U('Slide/addpic');?>" method="post">
            ...
            <div class="form-group">
                ...
                <div class="col-md-5" class="pic_box">
                    ...
                    <a class="thumbnail" href="javascript:swfupload('pic','<?php echo get_yzh_auth(1,'1MB',1);?>',yesdo)">
                        <img height="80" src="<?php if(!empty($vo["pic"])): echo ($vo["pic"]); else: ?>__IMG__/upload_thumb.png<?php endif; ?>" id="pic_pic" >
                    </a>
